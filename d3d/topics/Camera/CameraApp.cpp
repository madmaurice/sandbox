...
class CameraApp : public TopicApp
{
public:
	explicit CameraApp(HINSTANCE hInstance);
	~CameraApp();
...
, m_lightCount(3)
{
	...
	m_sphereMat.ambient  = XMFLOAT4(0.6f, 0.8f, 0.9f, 1.0f);
	m_sphereMat.diffuse  = XMFLOAT4(0.6f, 0.8f, 0.9f, 1.0f);
...
void CameraApp::InitGeometryBuffers()
{
    BuildShapeBuffers();
    BuildSkullBuffers();
}

void CameraApp::BuildSkullBuffers()
{
...
void CameraApp::BuildShapeBuffers()
{
...
void CameraApp::InitVertexLayout() { }
